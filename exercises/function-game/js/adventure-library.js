...
function isPlayerAttacking() {
    return player.classList.contains('attack-left')
        || player.classList.contains('attack-right')
        || player.classList.contains('attack-up')
        || player.classList.contains('attack-down');
}
...
function attack() {
    switch(playerDirection) {
        case DOWN:
            player.classList.add('attack-down');
            attackBlock(playerX, playerY+1);
            break;
        case UP:
            player.classList.add('attack-up');
            attackBlock(playerX, playerY-1);
            break;
        case LEFT:
            player.classList.add('attack-left');
            attackBlock(playerX-1, playerY);
            break;
        case RIGHT:
            player.classList.add('attack-right');
            attackBlock(playerX+1, playerY);
            break;
    }
}
...
function nudge() {
    switch(playerDirection) {
        case DOWN:
            player.classList.add('nudge-down');
            break;
        case UP:
            player.classList.add('nudge-up');
            break;
        case LEFT:
            player.classList.add('nudge-left');
            break;
        case RIGHT:
            player.classList.add('nudge-right');
            break;
    }
}
